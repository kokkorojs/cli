...
[![oicq](https://img.shields.io/badge/oicq-%3E%3Dv2.1.0-FCAA00?style=flat-square&labelColor=FAFAFA&logo=JavaScript&logoColor=FCAA00)](https://github.com/takayama-lily/oicq)
[![kokkoro](https://img.shields.io/badge/kokkoro-v1.0.0-57B497?style=flat-square&labelColor=FAFAFA&logo=npm&logoColor=FCAA00)](https://www.npmjs.com/package/kokkoro)
...
- 友好的脚手架，无需手动修改配置文件，全由命令自动构建，能有效避免因修改文件导致的占用或缓存文件产生的异常
- 账号并行登录，abot 启动项目是登录一个主号来执行后续相关操作，kokkoro 可自定义同步登录的账号（避免瞬间登录 **过多账号** ，可能会出现被封号的风险）
